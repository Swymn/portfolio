    ...
    return (
        <header className="flex flex-row items-center justify-between py-6 bg-blue">
            ...
            <div className="flex flex-row items-center justify-between min-w-[476px] px-12">
                ...
                <a href="https://github.com/Swymn" target="_blank" rel="noreferrer" className="flex flex-row justify-center items-center">
                    <svg className="w-6 h-6 mx-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                ...
                <Link to={AppRoute.NotFound} className="flex justify-center items-center w-12 h-12 rounded-full bg-white">
                    <svg className="w-6 h-6 fill-blue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
